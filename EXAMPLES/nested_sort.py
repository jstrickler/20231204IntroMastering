...
for person in sorted(computer_people, key=by_last_name_first_name):
    print(person)
print()

for person in sorted(computer_people, key=lambda p: (p[1], p[0])):
    print(person)
print()

for person in sorted(computer_people, key=lambda p: p[-1], reverse=True):
    print(person)
print()
